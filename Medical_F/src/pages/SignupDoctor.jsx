...
const SignupDoctor = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-slate-800 via-gray-900 to-slate-900 p-4">
      ...
      <div className="bg-white/95 backdrop-blur-md rounded-3xl shadow-2xl p-8 w-full max-w-3xl relative z-10 border border-cyan-100">
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold bg-gradient-to-r from-cyan-600 to-teal-600 bg-clip-text text-transparent mb-2">Doctor Registration</h2>
